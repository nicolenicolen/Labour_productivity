...
os.chdir('/p/tmp/vmaanen/new/Labour_Productivity/GCM_summary_warming/outdoor/')
...
for impact in impacts:
        for model in models:
            ...
            data.loc[impact,model,:,:] = xr.open_dataset(impact+'_'+model+'_rcp85_r1i1p1_EWEMBI_landonly.nc4')['Impact_1_5'] 

xr.Dataset({'Impact_1_5':data}).to_netcdf('/p/tmp/vmaanen/new/Labour_Productivity/Summary_warming/outdoor/Impact_1_5_LP_all_GCMs_warming.nc4')
