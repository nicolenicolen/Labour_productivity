	...
	for model in models:
		for impact in impacts:
			for year in years:
				...
				nc_impact = xr.open_mfdataset('/p/tmp/vmaanen/new/NAVIGATE/indoor/annual_projections/absolute/Impact_' + model + '_' + scenario + '_' + str(year) + '_r1i1p1_EWEMBI_landonly_id.nc4')
				...
				nc_historical = xr.open_mfdataset("/p/tmp/vmaanen/new/Labour_Productivity/GCM_summary_historical/indoor/Impact_" + model + "_historical_r1i1p1_EWEMBI_landonly.nc4")
