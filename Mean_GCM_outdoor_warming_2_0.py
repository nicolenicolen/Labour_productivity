...
for impact in impacts:
        for model in models:
            ...
            data.loc[impact,model,:,:] = xr.open_dataset(impact+'_'+model+'_rcp85_r1i1p1_EWEMBI_landonly.nc4')['Impact_2_0'] 

xr.Dataset({'Impact_2_0':data}).to_netcdf('/p/tmp/vmaanen/new/Labour_Productivity/Summary_warming/outdoor/Impact_2_0_LP_all_GCMs_warming.nc4')
